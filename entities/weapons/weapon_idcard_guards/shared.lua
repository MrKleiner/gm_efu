--Config
SWEP.PrintName = "Woldwater Guard ID Card"
...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/squad/sf_plates/sf_plate1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.45, 2.668, 3.269), angle = Angle(0, 0, -76.709), size = Vector(0.321, 0.642, 0.321), color = Color(255, 125, 0, 255), surpresslightning = false, material = "models/props_c17/paper01", skin = 0, bodygroup = {} }
}
...
function SWEP:Deploy()
	if self.Owner:IsPlayer() and self.FSF == false then
		self.FSF = true
		PrintMessage(HUD_PRINTCENTER,"You are Security Guard  of WoldWater Facility")
	end
