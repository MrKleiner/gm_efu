--Config
SWEP.PrintName = "FSF ID Card Commander"
...
SWEP.VElements = {
	["2element_name"] = { type = "Model", model = "models/squad/sf_plates/sf_plate1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.548, 44.308, -13.863), angle = Angle(39.689, 3.266, 8.654), size = Vector(0.128, 0.275, 0.037), color = Color(255, 255, 0, 255), surpresslightning = false, material = "models/props_c17/paper01", skin = 0, bodygroup = {} },
	["element_name"] = { type = "Model", model = "models/weapons/c_arms_combine.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(13.427, 29.368, 6.712), angle = Angle(-39.825, -180, -100.699), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/squad/sf_plates/sf_plate1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.45, 2.668, 3.269), angle = Angle(0, 0, -76.709), size = Vector(0.321, 0.642, 0.321), color = Color(255, 255, 0, 255), surpresslightning = false, material = "models/props_c17/paper01", skin = 0, bodygroup = {} }
}
...
SWEP.Primary.SpreadN = 2
SWEP.Primary.SpreadZ = 1
SWEP.FSF = false
...
function SWEP:Deploy()
	if self.Owner:IsPlayer() and self.FSF == false then
		self.FSF = true
		PrintMessage(HUD_PRINTCENTER,"You are FastSpecialForce Commander")
	end
...
list.Add( "NPCUsableWeapons", { class = "epg_m9",	title = "M9 Beretta" } )
