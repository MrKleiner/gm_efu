...
SWEP.Author = "FastSpecialForce US Company"
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_R_Forearm"] = { scale = Vector(1, 0.996, 1), pos = Vector(0, 4.717, 0.423), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(-5.481, -15.407, -20.71), angle = Angle(-180, 78.544, -117.819) }
}

SWEP.VElements = {
	["body"] = { type = "Model", model = "models/weapons/w_m4a1iron2.mdl", bone = "ValveBiped.base", rel = "", pos = Vector(-0.65, 2.96, 12.149), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_m4a1iron2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.863, -0.61, -0.956), angle = Angle(180, 0.363, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.Base 				    = "weapon_base"

--Primary Settings
SWEP.Primary.Sound = Sound("weapons/firearms/carbines/m4_shot1.wav") 
SWEP.Primary.NumberofShots = 1
SWEP.Primary.Damage = 15
SWEP.Primary.Delay = .083 -- cool but for balance - not.093
...
SWEP.IronSightsPos = Vector(-6.801, 0, 2.359)
SWEP.IronSightsAng = Vector(-0.74, 0, 0)

function SWEP:CanPrimaryAttack()


	if ( self.Weapon:Clip1() <= 0 ) and ( self.Weapon:Clip1() <= 15 ) then
	
		print("kabak")
		self:EmitSound( "weapons/concussion/light_concussion.wav" )
...
if self.Owner:IsPlayer() then bullet.Spread = Vector( self.Primary.Spread * 0.1 , self.Primary.Spread * 0.1, 0) end
bullet.Tracer = 1 
...
self.Owner:ViewPunch( Angle( -1 * self.Primary.Recoil, math.Rand( -0.9, 0.7 ) *self.Primary.Recoil, 1 ) ) --last 0
...
function SWEP:Initialize()
	...
	if SERVER and self.Owner:IsNPC() then
	    ...
	    self:SetNPCFireRate(0.25/(self.Primary.RPM/60))	
...
//list.Add( "NPCUsableWeapons", { class = "epg_m4a_npcs",	title = "EPG M4a1" } )
