...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Grenade_body"] = { scale = Vector(0.129, 0.129, 0.129), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_R_Finger0"] = { scale = Vector(1.097, 1.097, 0.825), pos = Vector(0.779, 0.717, -0.23), angle = Angle(31.888, 6.277, 7.015) }
}


SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Items/combine_rifle_cartridge01.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(0.541, -1.027, -2.317), angle = Angle(-159.545, 180, 30.742), size = Vector(0.797, 0.797, 0.797), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:Think()
	if self.Next < CurTime() then
		...
		elseif self.Primed == 2 then
			...
			if SERVER then
        	local ent = ents.Create("ammobox_pulserifle")
	...
	ent:SetCollisionGroup(SOLID_VPHYSICS)
				...
				self.Owner:RemoveAmmo(30, self.Primary.Ammo)
