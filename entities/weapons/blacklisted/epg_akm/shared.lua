...
SWEP.ViewModelFOV			= 52 --45
SWEP.UseHands			= true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
    ["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(2.684, 0.913, 0.377), angle = Angle(-0.327, 0, 0) },
    ["v_weapon.AK47_Parent"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
SWEP.VElements = {
    ["element_name"] = { type = "Model", model = "models/weapons/rif_ak47_alpha/w_ak47.mdl", bone = "v_weapon.AK47_Parent", rel = "", pos = Vector(0, 2.223, -8.297), angle = Angle(0, 180, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/atp/weapons/ak-12.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.819, 0.615, -1.2), angle = Angle(1.335, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
--Primary Settings
SWEP.Primary.Sound = Sound("weapons/firearms/rpk/rpk-1.wav") 
SWEP.Primary.NumberofShots = 1
SWEP.Primary.Damage = 98
SWEP.Primary.Delay = .0934 --.135
SWEP.Primary.ClipSize = 30
SWEP.Primary.DefaultClip = 360
SWEP.Primary.Automatic = true
SWEP.Primary.Force = 1.98
SWEP.Primary.TakeAmmo = 1
SWEP.Primary.Recoil = .9
SWEP.Primary.Ammo = "pistol"
SWEP.Primary.Tracer = "Tracer"
SWEP.Primary.SpreadN = .7
SWEP.Primary.SpreadZ = .12

--Secondary Settings
SWEP.Secondary.Ammo = "none"
SWEP.Secondary.ClipSize = 1

SWEP.IronSightsPos = Vector(-6.281, 0, 3.68)
SWEP.IronSightsAng = Vector(-1.038, 0.203, 0)
...
self:ShootEffects() 
self:EmitSound(self.Primary.Sound,500,100,1,-1) -- 22:17, 04.12.2021, 500 - radius of sound, FUCKING FINALLY!!!!!!!!!!
self.Owner:ViewPunchReset()
self.Owner:ViewPunch( Angle( -1 * self.Primary.Recoil, math.Rand( -0.2, 0.4 ) *self.Primary.Recoil, 1 ) ) --last 0
...
self.Zoomed = true 
if SERVER then
self.Owner:SetFOV( self.IronFov, self.IronTime ) 
self.Primary.Spread = self.Primary.SpreadZ
end
else
self.Zoomed = false
if SERVER then
...
self.Primary.Spread = self.Primary.SpreadN
	if SERVER then
	local launcher = ents.Create("epg_empty_mag")
...
list.Add( "NPCUsableWeapons", { class = "epg_kr74",	title = "KR47" } )
