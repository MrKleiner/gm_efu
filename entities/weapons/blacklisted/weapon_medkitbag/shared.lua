...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 0.748, 1), pos = Vector(4.649, 8.097, 12.55), angle = Angle(24.982, 0, 0) },
	["ValveBiped.Grenade_body"] = { scale = Vector(0.112, 0.112, 0.112), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}


SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Items/HealthKit.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(4.859, 2.46, -6.884), angle = Angle(106.363, 35.668, 0), size = Vector(0.856, 0.856, 0.856), color = Color(217, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
if ( CLIENT ) then
	...
	SWEP.Purpose			= ""
	SWEP.Instructions		= ""
	SWEP.PrintName			= "Medical Kit Bag"
	...
	killicon.AddFont("cs_hegrenade", "CSKillIcons", SWEP.IconLetter, Color(255, 80, 0, 255))
end
...
SWEP.WorldModel			= "models/weapons/w_eqs_fraggrenade.mdl"
SWEP.HoldType			= "grenade" --slam
...
SWEP.Primary.Ammo			= "slam" -- ammo type name
...
function SWEP:Think()
	...
	ent:SetCollisionGroup(SOLID_VPHYSICS)
				...
				self.Owner:RemoveAmmo(8, self.Primary.Ammo)
