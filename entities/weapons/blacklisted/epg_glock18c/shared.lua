...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_gdc_glock182.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.158, -1.958, -3.899), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_gdc_glock182.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.408, 1.901, -2.741), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
--Primary Settings
SWEP.Primary.Sound = Sound("weapons/firearms/g18/glock_fire1.wav") 
SWEP.Primary.NumberofShots = 1
SWEP.Primary.Damage = 32
SWEP.Primary.Delay = .1
SWEP.Primary.ClipSize = 20
SWEP.Primary.DefaultClip = 98 --+18 bullets helpful
SWEP.Primary.Automatic = true
SWEP.Primary.Force = .5
SWEP.Primary.TakeAmmo = 1
SWEP.Primary.Recoil = .34
SWEP.Primary.Ammo = "pistol"
SWEP.Primary.Tracer = "Tracer"
SWEP.Primary.SpreadN = .8
...
SWEP.IronSightsPos = Vector(-6.321, 0, 2.799)
SWEP.IronSightsAng = Vector(0.127, -0.278, 0)
...
self.Owner:ViewPunch( Angle( -1 * self.Primary.Recoil, math.Rand( -0.1, 0.3 ) *self.Primary.Recoil, 0 ) )
self.Owner:SetEyeAngles( self.Owner:EyeAngles() + Angle( -1.25, 0, 0 ) )
...
list.Add( "NPCUsableWeapons", { class = "epg_glock18c",	title = "EPG Glock18C" } )
