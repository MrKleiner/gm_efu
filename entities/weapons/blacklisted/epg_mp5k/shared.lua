...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.068, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_R_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(0.166, 4.816, 0.012), angle = Angle(1.087, -8.657, -0.187) }
}


SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_tak_mp5.mdl", bone = "ValveBiped.base", rel = "", pos = Vector(-0.044, 5.363, -11.665), angle = Angle(90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_gdc_ump452.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.937, 0, 0), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Primary.SpreadZ = .11

--Secondary Settings
SWEP.Secondary.Ammo = "none"
SWEP.Secondary.ClipSize = 1

SWEP.IronSightsPos = Vector(-6.281, 0, -0.04)
...
self.Owner:ViewPunch( Angle( -1 * self.Primary.Recoil, math.Rand( -0.2, 0.3 ) *self.Primary.Recoil, 1 ) ) --last 0
...
list.Add( "NPCUsableWeapons", { class = "epg_m4a",	title = "EPG M4a" } )
