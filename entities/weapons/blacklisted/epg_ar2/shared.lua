SWEP.PrintName = "Pulse Rifle"
    -- FastSpecialForce-11
SWEP.Author = "Punker"
SWEP.Contact = "FastSpecialForce-11"
SWEP.Purpose = "AR-2"
SWEP.Instructions = ""
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_crifle.mdl", bone = "Base", rel = "", pos = Vector(-0.634, 2.95, 15.713), angle = Angle(-93.662, 88.351, 1.95), size = Vector(1.046, 1.046, 1.046), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
