...
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/weapons/w_gdcm9.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(-0.239, -2.754, -4.245), angle = Angle(90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_gdcm9.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.789, 2.046, -3.095), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
--Primary Settings
SWEP.Primary.Sound = Sound("weapons/firearms/g9/beretta9_fire1.wav") 
