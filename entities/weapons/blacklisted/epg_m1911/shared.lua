...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_gdcm1911.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(-0.246, -2.267, -5.057), angle = Angle(90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_gdcm1911.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.064, 1.516, -2.691), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.Base 				    = "weapon_base"
SWEP.WeaponDeploySpeed		 = 1.5
...
--Primary Settings
SWEP.Primary.Sound = Sound("weapons/firearms/1911/1911_fire1.wav") 
SWEP.Primary.NumberofShots = 1
SWEP.Primary.Damage = 43
SWEP.Primary.Delay = .135
...
SWEP.IronSightsPos = Vector(-6.12, 0, 3.039)
...
list.Add( "NPCUsableWeapons", { class = "epg_m1911",	title = "EPG M1911" } )
