--Config
SWEP.PrintName = "50C. Desert Eagle"
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-26.05, -21.827, 47.645) }
}
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_gdcdeagle.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0, -2.421, -4.482), angle = Angle(90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/w_gdcdeagle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.565, 1.565, -2.181), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
--Primary Settings
SWEP.Primary.Sound = Sound("weapons/firearms/deagle/deserteagle_fire1.wav") 
...
SWEP.Primary.SpreadZ = .112

--Secondary Settings
SWEP.Secondary.Ammo = "none"
SWEP.Secondary.ClipSize = 1

SWEP.IronSightsPos = Vector(-6.2, 0, 2.599)
...
self.Owner:ViewPunch( Angle( -3 * self.Primary.Recoil, math.Rand( -0.2, 0.6 ) *self.Primary.Recoil, 0 ) )
...
list.Add( "NPCUsableWeapons", { class = "epg_deserteagle",	title = "EPG DesertEagle" } )
