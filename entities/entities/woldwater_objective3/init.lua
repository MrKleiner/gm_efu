...
if v then
v:PrintMessage( HUD_PRINTCENTER, "[FSF Commander]: Objective list is updated." )
...
v:PrintMessage( HUD_PRINTTALK, "Get into canals, there is level, that turns on electricity in the complex...something bad happen, use secondary spare level." ) -- N E W  O B J E C T I V E  M E S S A G E  T Y P E  H E R E /!\ 
end)
end
end
end
