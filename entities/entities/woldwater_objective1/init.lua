...
v:PrintMessage( HUD_PRINTTALK, "1. Get the data of WW & open the doors through security disable bat file." )
v:PrintMessage( HUD_PRINTTALK, "2. Get the keys for doors of complex." ) -- N E W  O B J E C T I V E  M E S S A G E  T Y P E  H E R E /!\ 
end)
end
end
end
