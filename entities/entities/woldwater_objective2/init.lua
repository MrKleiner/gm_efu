...
v:PrintMessage( HUD_PRINTCENTER, "[FSF Commander]: New objectives are in the chat." )
v:EmitSound( "efu/message.wav" )
v:PrintMessage( HUD_PRINTTALK, "Find the documents of:" ) 
v:PrintMessage( HUD_PRINTTALK, "1. Our contract with WWCorp, wroten on document." ) -- lo all new words from big letter (Go Move There)
v:PrintMessage( HUD_PRINTTALK, "2. Find description document of UNIT-7." )
v:PrintMessage( HUD_PRINTTALK, "3. Get the disk of experminets." )-- N E W  O B J E C T I V E  M E S S A G E  T Y P E  H E R E /!\ 
end)
end
end
end
